...
function interactive_image_hover_shortcode() {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const svgLayers = document.querySelectorAll(".layer.svg");
            ...
            svgLayers.forEach((svg) => {
                svg.addEventListener("mousemove", (e) => {
                    ...
                    if (point && svg.contains(point)) {
                        svgLayers.forEach((layer) => layer.classList.remove("hovered", "grayscale"));
                        ...
                        // Show tooltip
                        tooltip.innerText = svg.dataset.name;
